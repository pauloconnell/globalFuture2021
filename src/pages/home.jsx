    ...
    <html>
      ...
      <body>
        ...
        <div id="details">
          ...
          <br />
          <br />
          <br />• Essentially like the UN but expanded to invite all countries
          and every person in the world to become a citizen of this 'Global
          Country'. Like the UN, the richest countries, or those with largest
          militaries, shall bear the bulk of the cost of the population
          management plan (below).
          <br />
          <br />• All contributing countries shall have a role in the updating
          and governance of the world's Global Standards. <br />
          ...
          participating countries. Arms dealers to be restricted to selling to
          the government only, and not to non-contributory countries.
          <br />
          ...
          nations. Of these representatives, a target shall be set to achieve
          50% female representatives. Proposals from all tiers shall be debated
          and agreed by the Council of Next Tier Nations, and presented to the
          Prime Nations for action.
          <br />
